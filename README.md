...
psrm-24-layouts is a [NodeCG](http://github.com/nodecg/nodecg) bundle.
...
Don't forget to place both bundles (`psrm-24-layouts` and `nodecg-speedcontrol`) in the `bundles` folder of your NodeCG installation.
